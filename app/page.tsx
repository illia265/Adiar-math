...
import { Camera, Upload, Send, MessageSquare, Download, School, Target, Zap, BookOpen, TrendingUp, X, User, LogOut } from 'lucide-react'
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-8 max-w-md w-full mx-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center space-x-3 bg-white border border-gray-300 rounded-lg px-4 py-3 text-gray-700 font-medium hover:bg-gray-50 transition-colors"
            >
        ...
        <div className="bg-white rounded-xl border-2 border-gray-200 p-8 shadow-sm">
          ...
          >
            ...
            <div className="mb-6">
              ...
              {pastedImages.length > 0 && (
                <div className="mt-4">
                  <h4 className="text-sm font-medium text-gray-700 mb-2">Pasted Images:</h4>
          ...
          <div className="flex justify-between items-center">
            <div className="flex space-x-2">
              <button className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg font-medium hover:bg-gray-200 text-sm">
                Desmos Input
              </button>
              <button className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg font-medium hover:bg-gray-200 text-sm">
                SAT Tools
               ...
               className="px-6 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
             >
        ...
        <div className="mt-16 bg-blue-50 rounded-xl p-8">
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <button className="px-6 py-3 bg-white text-blue-600 border border-blue-600 rounded-lg font-medium hover:bg-blue-50">
                Learn More
              </button>
            </div>
          </div>
          ...
          <div className="flex justify-center items-center">
            <div className="flex items-center space-x-2">
              <Image 
                ...
                className="rounded-lg"
              />
              <span className="text-sm text-gray-600">Adiar Math can make mistakes. Please double check important steps and calculations.</span>
            </div>
          </div>
